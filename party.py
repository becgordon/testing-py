...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Tavish', 'mel@ubermelon.com')
    True
    >>> is_mel('Judith Butler', 'judith@awesome.com')
    False
    >>> is_mel('MEL MELITPOLSKI','mel@ubermelon.com')
    True
    >>> is_mel('Bec', 'MEL@UBERMELON.COM')
    True
